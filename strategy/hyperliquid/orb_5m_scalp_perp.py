"""
Hyperliquid perp — ORB 5m Scalp (Casper SMC opening range breakout + retest).
"""
...
from strategy.playbooks.orb_5m_scalp_engine import (
    evaluate_orb_5m_scalp,
    params_from_config,
)


class Orb5mScalpPerpStrategy(BasePerpStrategy):
    STRATEGY_NAME = "ORB 5m Scalp Perp"
