"""VWAP/RSI mean-reversion — spot long-only wrapper (1h range + 15m reclaim)."""
...
class VwapRsiMeanReversionStrategy(BaseStrategy):
    STRATEGY_NAME = "VWAP RSI Mean Reversion"
